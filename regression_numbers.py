...
if __name__ == "__main__":
    ...
    reversedfails_bm = [numword for numword in numberwds_bm if convert_nums(numword, reverse=True) is None]

    reversedfails_nn = [numword for numword in numberwds_nn if convert_nums(numword, reverse=True, nn=True) is None]
