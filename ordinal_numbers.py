...
b_ordinals_bm = {1: 'første', 2: 'andre', 3: 'tredje', 4: 'fjerde', 5: 'femte', 6: 'sjette',
                 7: 'sjuende', 8: 'åttende', 9: 'niende'}

b_ordinals_nn = {1: 'første', 2: 'andre', 3: 'tredje', 4: 'fjerde', 5: 'femte', 6: 'sjette',
                 7: 'sjuande', 8: 'åttande', 9: 'niande'}

# 11.-19.
t_ordinals_bm = {11: 'ellevte', 12: 'tolvte', 13: 'trettende', 14: 'fjortende', 15: 'femtende', 
                16: 'sekstende', 17: 'syttende', 18: 'attende', 19: 'nittende'}
t_ordinals_nn = {11: 'ellevte', 12: 'tolvte', 13: 'trettande', 14: 'fjortande', 15: 'femtande', 
                16: 'sekstande', 17: 'syttande', 18: 'attende', 19: 'nittande'}

# 20, 30, 40 50, 60, 70, 80, 90
do_ordinals_bm = {20: 'tjuende', 30: 'trettiende', 40: 'førtiende', 50: 'femtiende',
                  60: 'sekstiende', 70: 'syttiende', 80: 'åttiende', 90: 'nittiende'}
do_ordinals_nn = {20: 'tjuande', 30: 'trettiande', 40: 'førtiande', 50: 'femtiande',
                  60: 'sekstiande', 70: 'syttiande', 80: 'åttiande', 90: 'nittiande'}
...
def _ordinal_to_cardinal(ordinal, nn=False):
    ...
    if type(ordinals_to_nn_rev(ordinal)) is int and nn == False:
        ...
        hundre_or_tusen = convert_nums(myint).split(' ')[-1] #to avoid "ett" in "ett tusen"
...
if __name__ == "__main__":
    ...
    print("Digit conversion bm: %s\nString conversion bm: %s" % (convert_ords(mydigit), convert_ords(mynumstring, reverse=True)))
    print("Digit conversion nn: %s\nString conversion nn: %s" % (convert_ords(mydigit_nn, nn=True), convert_ords(mynumstring_nn, nn=True, reverse=True)))
